...
if (!$cache_loaded) {
	...
	// Paths and URLs
		// Main installation directory
			...
			$cf['KU_WEBFOLDER'] = 'http://kusaba.localhost/'; // The path from the domain of the board to the folder which kusaba is in, including the trailing slash.  Example: "http://www.yoursite.com/misc/kusaba/" would have a $cf['KU_WEBFOLDER'] of "/misc/kusaba/"
